...
function bsf_systeminfo() {
	...
	<table class="wp-list-table widefat fixed bsf-sys-info">
		<tbody>
		<tr class="alternate">
			<th colspan="2"><?php esc_html_e( 'WordPress Environment', 'astra-addon' ); ?></th>
		</tr>
		<tr>
			<td>Home URL</td>
		...
		<tr>
			...
			<td>
				<?php
				$wp_up = wp_upload_dir();
				echo ( is_writable( $wp_up['basedir'] ) ) ? 'Writable' : 'Readable'; // phpcs:ignore WordPress.WP.AlternativeFunctions.file_system_operations_is_writable
				?>
			</td>
		</tr>
		<tr>
	...
	<table class="wp-list-table widefat fixed bsf-sys-info">
		<tbody>
		<tr class="alternate">
			<th colspan="2"><?php esc_html_e( 'Server Environment', 'astra-addon' ); ?></th>
		</tr>
		<tr>
			<td>Server Info</td>
	...
	<table class="wp-list-table widefat fixed bsf-sys-info">
		<tbody>
		<tr class="alternate">
			<th colspan="2"><?php esc_html_e( 'Theme Information', 'astra-addon' ); ?></th>
		</tr>
	...
	<table class="wp-list-table widefat fixed bsf-sys-info bsf-table-active-plugin">
		<tbody>
		<tr class="alternate">
			<th colspan="4"><?php esc_html_e( 'Installed Plugins', 'astra-addon' ); ?></th>
		</tr>
		<?php
		$plugins = get_plugins();
		asort( $plugins );
