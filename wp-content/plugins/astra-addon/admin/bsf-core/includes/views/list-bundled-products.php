...
$reset_bundled_url = wp_nonce_url(
	bsf_exension_installer_url( $product_id . '&remove-bundled-products&redirect=' . $redirect_url ),
	'bsf-remove-bundled-products'
);
...
<div class="wrap about-wrap bsf-sp-screen bend <?php echo 'extension-installer-' . sanitize_html_class( $product_id ); ?>">
	...
	<div class="bend-heading-section extension-about-header">
		...
		<div class="bend-head-logo">
			<div class="bend-product-ver"><?php esc_html_e( 'Extensions ', 'astra-addon' ); ?></div>
		</div>
	</div>  <!--heading section-->

	<div class="bend-content-wrap">
		<hr class="bsf-extensions-lists-separator">
		<h3 class="bf-ext-sub-title"><?php esc_html_e( 'Available Extensions', 'astra-addon' ); ?></h3>
		...
		<div class="bsf-extensions-no-active">
			...
			<p class="bsf-text-light"><em><?php esc_html_e( 'No extensions available yet!', 'astra-addon' ); ?></em></p>

			<div class="bsf-cp-rem-bundle" style="margin-top: 30px;">
				<a class="button-primary" href="<?php echo( htmlentities( $reset_bundled_url, ENT_QUOTES, 'utf-8' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"><?php esc_html_e( 'Refresh Bundled Products', 'astra-addon' ); ?></a>
			</div>
		</div>
			<?php
		} else {
		...
		<hr class="bsf-extensions-lists-separator">
		<h3 class="bf-ext-sub-title"><?php esc_html_e( 'Installed Extensions', 'astra-addon' ); ?></h3>
		<ul class="bsf-extensions-list">
