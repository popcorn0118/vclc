...
if ( ! class_exists( 'Astra_Theme_Extension' ) ) {
	...
	class Astra_Theme_Extension {
		...
		public function preview_init() {
			...
			wp_enqueue_script( 'astra-addon-customizer-preview-js', ASTRA_EXT_URI . $js_path, array( 'customize-preview', 'astra-customizer-preview-js', 'astra-addon-customizer-preview-helper' ), ASTRA_EXT_VER, true );
