...
class Astra_Addon_Cache extends Astra_Cache_Base {
	 ...
	 *
	 * @since 2.1.0
	 * @param int|mixed $post_id Optional. Post ID to refresh cache for specific post, or WP_Customize_Manager object from customize_save hook.
	 * @return void
	 */
	public function astra_refresh_assets( $post_id = null ) {
		parent::refresh_assets( $this->cache_dir, $post_id );
	}
