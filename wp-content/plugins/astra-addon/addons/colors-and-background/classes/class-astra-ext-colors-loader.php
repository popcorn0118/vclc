...
if ( ! class_exists( 'Astra_Ext_Colors_Loader' ) ) {
	...
	class Astra_Ext_Colors_Loader {
		...
		public function preview_scripts() {
			...
			wp_enqueue_script( 'astra-ext-colors-customize-preview-js', ASTRA_ADDON_EXT_COLORS_URI . $js_path, array( 'customize-preview', 'astra-customizer-preview-js', 'astra-addon-customizer-preview-js', 'astra-addon-customizer-preview-helper' ), ASTRA_EXT_VER, true );
