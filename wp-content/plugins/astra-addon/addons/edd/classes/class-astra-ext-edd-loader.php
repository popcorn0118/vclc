...
if ( ! class_exists( 'Astra_Ext_Edd_Loader' ) ) {
	...
	class Astra_Ext_Edd_Loader {
		...
		public function preview_scripts() {
			...
			wp_enqueue_script( 'ast-edd-customizer-preview', ASTRA_ADDON_EXT_EDD_URI . $js_path, array( 'customize-preview', 'astra-customizer-preview-js', 'astra-addon-customizer-preview-helper' ), ASTRA_EXT_VER, true );
		}
	}
}
