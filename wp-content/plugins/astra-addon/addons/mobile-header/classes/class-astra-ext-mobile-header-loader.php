 ...
 // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound
		...
		public function new_customize_register( $wp_customize ) {
			...
			if ( astra_addon_existing_header_footer_configs() ) {
				require_once ASTRA_ADDON_EXT_MOBILE_HEADER_DIR . 'classes/sections/class-astra-customizer-mobile-header-configs.php';
				require_once ASTRA_ADDON_EXT_MOBILE_HEADER_DIR . 'classes/sections/class-astra-customizer-mobile-above-header-configs.php';
		...
		public function preview_scripts() {
			...
			if ( SCRIPT_DEBUG ) {
				wp_enqueue_script( 'astra-ext-mobile-header-customize-preview-js', ASTRA_ADDON_EXT_MOBILE_HEADER_URL . 'assets/js/unminified/customizer-preview.js', array( 'customize-preview', 'astra-customizer-preview-js', 'astra-addon-customizer-preview-helper' ), ASTRA_EXT_VER, true );
			} else {
				wp_enqueue_script( 'astra-ext-mobile-header-customize-preview-js', ASTRA_ADDON_EXT_MOBILE_HEADER_URL . 'assets/js/minified/customizer-preview.min.js', array( 'customize-preview', 'astra-customizer-preview-js', 'astra-addon-customizer-preview-helper' ), ASTRA_EXT_VER, true );
			}
		}
