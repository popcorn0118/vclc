...
if ( ! @file_exists( 'D:\eos\vclc\wp-content\plugins\breeze/breeze.php' ) ) { return; }
$config['config_path'] = 'D:\eos\vclc/wp-content/breeze-config/breeze-config.php';
...
if ( @file_exists( 'D:\eos\vclc\wp-content\plugins\breeze/inc/cache/execute-cache.php' ) ) {
	include_once 'D:\eos\vclc\wp-content\plugins\breeze/inc/cache/execute-cache.php';
